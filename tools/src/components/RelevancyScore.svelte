<script lang="ts">
    ...
    const baseClasses = 'h-4 w-4 rounded-full border border-black'
...
<div class="flex gap-1">
    ...
    <div class={cx(baseClasses, numberOfDots >= 4 ? 'bg-black' : '')} />
    <div class={cx(baseClasses, numberOfDots >= 5 ? 'bg-black' : '')} />
</div>
