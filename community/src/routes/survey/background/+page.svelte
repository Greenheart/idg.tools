<script lang="ts">
    ...
    const t = {
        ...
        md_phaseText1:
            'During this phase co-creation have been conducted with more than 100 researchers across the globe to develop the survey and other methods. In parallel, information meetings have been conducted with so called multipliers (i.e international networks, global organizations, IDG Partner organizations & IDG Hubs) who are interested to help share the survey to reach. To get a comprehensive and inclusive dataset we aim at engaging at least 100 countries with 2M people who view the survey out which 100.000 respond. Researchers and multipliers have quality controlled the automatically generated translations of the survey.',
        md_phaseText2:
