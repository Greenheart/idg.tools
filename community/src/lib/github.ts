...
const TEMPLATES = {
    FEEDBACK: {
        ...
        disclaimer:
            '## Disclaimer\nThe following feedback was submitted by an user of https://idg.community. This has not yet been reviewed or approved by the contributors.\n\n---\n',
    },
    CONTENT_SUGGESTION: {
        title: 'App Content Suggestion',
        labelIds: [LABEL_IDS.NEEDS_REVIEW, LABEL_IDS.CONTENT_SUGGESTION],
        disclaimer:
            '## Disclaimer\nThe following content suggestion was submitted by an user of https://idg.community. This has not yet been reviewed or approved by the contributors.\n\n---\n',
    },
}
